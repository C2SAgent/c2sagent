...
async def get_current_user(
    ...
    try:
        ...
        # 异步查询用户
        result = await db.execute(select(UserConfig).where(UserConfig.name == username))
...
async def get_current_active_user(current_user: UserConfig = Depends(get_current_user)):
    """获取当前活跃用户"""
